		...
		<div class="main-painel">
			<div class="row">
					<?php
						...
						echo "<div>";
						echo "<span style='text-align: center; font-family: Verdana; font-size: 30px; color: #16578b; font-weight: bold;'>ALTERAR NOME</span>";
						echo "<form method='POST' action='alterarnome.php'>";
						echo 	"<div class='mb-1'>";
						echo 		"<input type='text' name='nomeProfissional'  class='form-control' value='$nome_profissional' required>";
						echo 	"</div>";
						echo 	"<br><div class='mb-1'>";
						echo 	"<input name='sobrenomeProfissional' type='text' class='form-control' value='$sobrenome_profissional' required />";
						echo 	"</div>";
