...
<header>
	...
	<div class="content painel">
		<div class="main-painel">
			<div class="row">
					<?php
						$cod_servico = $_SESSION['id_servico'];
						echo "<div>";
						echo "<span style='text-align: center; font-family: Verdana; font-size: 30px; color: #16578b; font-weight: bold;'>MINHAS REGIÕES DE ATENDIMENTO</span>";
						echo "<form method='POST' action='regioesdeatendimento_edicao.php'>";
						...
						echo 	"</thead>";
							...
							while ($regioesdeservico = mysqli_fetch_array($sql_query_regiao)){
								...
								echo 		"<td style='padding: 20px;'><a class='abutaoexcluir' href='excluir_servico.php?cod_regiao=$id_regiao'>Excluir</a></td>";
								echo 	"</tr>";
							}
						...
						echo 	"<br><button type='submit' class='btn btn-primary'>Adicionar mais regiões</button>";
						echo 	"</form>";
