		...
		<div class="main-painel">
			<div class="row">
					<?php
						...
						echo "<div>";
						echo "<span style='text-align: center; font-family: Verdana; font-size: 30px; color: #16578b; font-weight: bold;'>CONTATOS | REDES SOCIAIS</span>";
						echo "<form method='POST' action='alterarcontatos.php'>";
						echo 	"<div class='mb-1' style='text-align: left;'>";
						echo 		"<label for='telefone' class='form-label'>TELEFONE</label><br>";
						echo 		"<input type='text' name='tellProfissional'  class='form-control' placeholder='Telefone' value='$telefone_profissional' id='telefone' required>";
						echo 	"</div>";
						echo 	"<div class='mb-1' style='text-align: left;'>";
						echo 		"<label for='instagram' class='form-label'>INSTAGRAM</label><br>";
						echo 		"<input name='instaProfissional' type='text' class='form-control' placeholder='Instagram' value='$insta_profissional' id='instagram' />";
						echo 	"</div>";
						echo 	"<div class='mb-1' style='text-align: left;'>";
						echo 		"<label for='facebook' class='form-label'>FACEBOOK</label><br>";
						echo 		"<input name='faceProfissional' type='text' class='form-control' placeholder='Facebook' value='$face_profissional' id='facebook' />";
						echo 	"</div>";
						echo 	"<div class='mb-1' style='text-align: left;'>";
						echo 		"<label for='zap' class='form-label'>WHATSAPP</label><br>";
						echo 		"<input name='zapProfissional' type='text' class='form-control' placeholder='Whatsapp' value='$zap_profissional' id='zap' />";
						echo 	"</div>";
