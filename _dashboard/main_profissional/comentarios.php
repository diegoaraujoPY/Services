		...
		<div class="main-painel">
			<div class="row">
				<?php
					...
					$sql_query_comentarios = $mysqli->query($sql_code_comentario) or die("Falha na execução do código SQL" . $msqli->error);
					
					$quantidade = $sql_query_comentarios->num_rows;
					
					if($quantidade==1){
						echo "<span style='font-family: Verdana; font-size: 20px; text-align: left; margin: 20px;'><b>$quantidade Comentário</b></span><br>";
					} else {
						echo "<span style='font-family: Verdana; font-size: 20px; text-align: left; margin: 20px;'><b>$quantidade Comentários</b></span><br>";
					}
					
					echo "<div class='row embed-responsive embed-responsive-16by9'>";
					echo 	"<iframe class='embed-responsive-item' height='400' src='../../_contrato/comentarios.php?cod_servico=$id_servico#comentarios'></iframe>";
					echo "</div>";
					echo "<form action='myservicos.php'>";
