<?php
	...
	$sql_code = "SELECT MAX(id_servico) as id_servico FROM servico WHERE id_profissional = '$id_profissional'";
	...
	if($quantidade == 1){
		...
		$_SESSION['id_servico_regiao'] = $servico['id_servico'];
	}
?>
...
<header>
	...
	<div class="container painel" style="min-height: 100%;">
		<div class="main-painel">
			<div class="row">
					<?php
						echo "<div>";
						echo "<span style='text-align: center; font-family: Verdana; font-size: 30px; color: #16578b; font-weight: bold;'>ADICIONAR REGIÕES DE ATENDIMENTO</span>";
						echo "<form method='POST' action='adicionaregião_edicao.php'>";
						echo 	"<div class='mb'>";
						echo 		"<input type='text' class='form-control' placeholder='CEP' id='cep' onblur='pesquisacep(this.value);'>";
						echo 	"</div><br>";
						echo 	"<div class='row'>";
						echo 		"<div class='col-8'>";
						echo 			"<input type='text' name='cidadeServico' class='form-control' placeholder='Cidade' id='cidade' required>";
						echo 		"</div>";
						echo 		"<div class='col-2'>";
						echo 			"<input type='text' name='ufServico' class='form-control' placeholder='UF' maxlength='2' id='uf' required>";
						echo 		"</div>";
						echo 	"</div>";
						echo 	"<br><button type='submit' class='btn btn-primary'>Enviar</button>";
						echo 	"</form>";
						echo 	"<form method='POST' action='myservicos.php'>";
