	...
	<div class="content painel">
		<div class="main-painel">
			<div class="row">
					<?php
						echo "<div>";
						echo "<span style='text-align: center; font-family: Verdana; font-size: 30px; color: #16578b; font-weight: bold;'>ALTERE A SUA SENHA</span>";
						echo "<form method='POST' action='alterarsenha.php'>";
						echo 	"<div class='mb-1' style='text-align: left;'>";
						echo 		"<label for='senhaAntiga' class='form-label'>SENHA ANTIGA</label><br>";
						echo 		"<input type='password' name='senhaProfissional'  class='form-control'  id='senhaAntiga' required>";
						echo 	"</div>";
						echo 	"<div class='mb-1' style='text-align: left;'>";
						echo 		"<label for='novaSenha' class='form-label'>NOVA SENHA</label><br>";
						echo 		"<input name='NovaProfissional' type='password' class='form-control'  id='novaSenha' required />";
						echo 	"</div>";
						echo 	"<div class='mb-1' style='text-align: left;'>";
						echo 		"<label for='confirmeNovaSenha' class='form-label'>CONFIRMAR NOVA SENHA</label><br>";
						echo 		"<input name='ConfirmeNovaP' type='password' class='form-control' id='confirmeNovaSenha' required />";
						echo 	"</div>";
						echo 	"<br><button type='submit' class='btn btn-primary'>Alterar Senha</button>";
						echo "</form>";
						echo "<form method='' action='configuracoes.php'>";
						echo 	"<br><button type='submit' class='btn btn-danger'>Cancelar</button>";
						echo "</form>";
						echo "</div>";
					?>
				</div>
