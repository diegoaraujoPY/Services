<?php
	...
	$id_avaliacao = $_SESSION['id_avalie'];
	
	$editar_avaliacao = mysqli_connect('localhost','root','','services') or die ("Erro ao se conectar ao Bando de Dados");
	$sql = "UPDATE avaliacao SET _data = '$hoje_avalie', qualidade = '$qualidade', comentario = '$comentario', recomendacao = '$recomendo' WHERE id_av = $id_avaliacao";
	mysqli_query($editar_avaliacao,$sql) or die ("Erro ao tentar cadastrar registro");
	mysqli_close($editar_avaliacao);
