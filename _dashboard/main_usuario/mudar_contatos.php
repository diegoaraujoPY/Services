		...
		<div class="main-painel">
			<div class="row">
					<?php
						...
						echo "<div>";
						echo "<span style='text-align: center; font-family: Verdana; font-size: 30px; color: #16578b; font-weight: bold;'>CONTATO</span>";
						...
						echo 		"<input type='text' name='tellUsuario'  class='form-control' placeholder='CEP' value='$telefone_usuario' id='telefone' required>";
						echo 	"</div>";
