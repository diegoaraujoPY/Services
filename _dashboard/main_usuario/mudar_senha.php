		...
		<div class="main-painel">
			<div class="row">
					<?php
						...
						echo 		"<input type='password' name='senhaUsuario'  class='form-control'  id='senhaAntiga' required>";
						echo 	"</div>";
						echo 	"<div class='mb-1' style='text-align: left;'>";
						echo 		"<label for='novaSenha' class='form-label'>NOVA SENHA</label><br>";
						echo 		"<input name='NovaUsuario' type='password' class='form-control'  id='novaSenha' required />";
						echo 	"</div>";
						echo 	"<div class='mb-1' style='text-align: left;'>";
						echo 		"<label for='confirmeNovaSenha' class='form-label'>CONFIRMAR NOVA SENHA</label><br>";
						echo 		"<input name='ConfirmeNovaU' type='password' class='form-control' id='confirmeNovaSenha' required />";
						echo 	"</div>";
