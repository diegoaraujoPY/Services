		...
		<div class="main-painel">
			<div class="row">
					<?php
						...
						echo 	"<div class='mb'>";
						echo 		"<input type='text' name='cepUsuario'  class='form-control' placeholder='CEP' value='$cep_usuario' onblur='pesquisacep(this.value);' id='cep' required>";
						echo 	"</div><br>";
						echo 	"<div class='row'>";
						echo 		"<div class='col-8'>";
						echo 			"<input type='text' name='cidadeUsuario' class='form-control' placeholder='Cidade' value='$cidade_usuario' id='cidade' required>";
						echo 		"</div>";
						echo 		"<div class='col-2'>";
						echo 			"<input type='text' name='ufUsuario' class='form-control' placeholder='UF' value='$uf_usuario' maxlength='2' id='uf' required>";
						echo 		"</div>";
						echo 	"</div>";
						echo 	"<div class='mb'>";
						echo 		"<input name='bairroUsuario' type='text' class='form-control' placeholder='Bairro' value='$bairro_usuario' required />";
						echo 	"</div>";
						echo 	"<br><div class='row'>";
						echo 		"<div class='col-8'>";
						echo 			"<input type='text' name='ruaUsuario' class='form-control' placeholder='Rua' value='$rua_usuario' required>";
						echo 		"</div>";
						echo 		"<div class='col-2'>";
						echo 			"<input type='text' name='numUsuario' class='form-control' placeholder='N°' value='$n_usuario' maxlength='3'>";
						echo 		"</div>";
						echo 	"</div>";
