		...
		<div class="main-painel">
			<div class="row">
					<?php
						...
						echo 	"<div class='mb-1'>";
						echo 		"<input type='text' name='nomeUsuario'  class='form-control' value='$nome_usuario' required>";
						echo 	"</div>";
						echo 	"<br><div class='mb-1'>";
						echo 	"<input name='sobrenomeUsuario' type='text' class='form-control' value='$sobrenome_usuario' required />";
						echo 	"</div>";
