		...
		<div class="main-painel">
			<div class="row">
					<?php
						...
						echo "<span style='font-size: 28px; font-family: Verdana; color: #16578b; font-weight: bold; text-align: left;'>ID DE ACESSO: $id_profissional</span>";
						echo "<span style='font-size: 12px; font-family: Verdana; color: red; font-weight: bold; text-align: left;'>NÃO PERCA ESSE CÓDIGO DE ACESSO</span>";
						echo "<span style='font-size: 28px; font-family: Verdana; color: #16578b; font-weight: bold; padding: 10px'>CONFIGURAÇÕES!</span>";
						echo "<a style='text-decoration: none;' href='mudar_nome.php'>";
						echo 	"<ul class='nav justify-content-left opcoes'>";
						echo 	"<span style='text-align: center; font-size: 20px;'>Nome e Sobrenome</span>";
						echo "</ul>";
						echo "<a style='text-decoration: none;' href='mudar_endereco.php'>";
						echo 	"<ul class='nav justify-content-left opcoes'>";
						echo 	"<span style='text-align: center; font-size: 20px;'>Endereço</span>";
						echo "</ul>";
						echo "<a style='text-decoration: none;' href='mudar_contatos.php'>";
						echo 	"<ul class='nav justify-content-left opcoes'>";
						echo 	"<span style='text-align: center; font-size: 20px;'>Contato</span>";
						echo "</ul>";
						echo "<a style='text-decoration: none;' href='mudar_senha.php'>";
						echo 	"<ul class='nav justify-content-left opcoes'>";
						echo 	"<span style='text-align: center; font-size: 20px;'>Senha</span>";
						echo "</ul>";
						echo "<form action='../main_usuario.php'>";
