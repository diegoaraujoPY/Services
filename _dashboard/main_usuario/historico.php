	...
	<div class="content painel">
		<div class="main-painel">
			<div class="row">
				<?php
					$id_usuario = $_SESSION['id_usuario'];
					echo "<span style='font-size: 35px; font-family: Verdana; color: #16578b; font-weight: bold; text-align: center;'>HISTÓRICO DE SERVIÇOS!</span>";
							
					echo "<div class='row embed-responsive embed-responsive-16by9'>";
					echo 	"<iframe class='embed-responsive-item' width='650' height='400' src='historico_trabalhos.php#historico'></iframe>";
					echo "</div>";
					
					echo 	"<div class='row'>";
					echo 		"<div class='col' style='text-align: right;'>";
					echo 			"<a class='abutaoeditar' style='margin: 10px;' href='../main_usuario.php'>Voltar</a>";
					echo 		"</div>";
					echo 	"</div>";
