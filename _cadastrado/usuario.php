...
<header>
	<nav class="navegacao">
		<div class="">
			<ul class="nav justify-content-end">
				<li class="nav-item">
					<a class="nav-link" href="../_paginas/login_usuario.php"><img class="navbar-brand" src="../_icones/entre.png" alt="" width="22" height="32">Login</a>
				</li>
			</ul>
		</div>
	</nav>
	...
	<div class="container cadheight cadastrado">
		<legend class="cadastrosucesso">Usuário cadastrado com sucesso!</legend><br>
        <div class="row">
			<div class="col">
			<div class="idusuario" style="padding: 20px;">
				...
				<tr>
					<td>
						<img src="../_icones/_tipo/sou_usuario.png" style="padding: 10px;" class="figure-img img-fluid rounded" width="240" height="240" alt="">
					</td>
					<td>
						<h4 style="text-align: center;">O seu usuário de acesso está pronto!</h4>
						<div class="idusuario">
							<?php
								...
								while ($registro = mysqli_fetch_array($ultimo_id)){
									...
									echo "<h1 style='text-align: center; font-size: 50px;'>$id_usuario</h1>";
								}
								mysqli_close($conexao);
							?>
						</div>
						<h6 style="text-align: center; color: red; font-weight: bold;">Não perca o seu código de usuário!</h6>
					</td>
				<tr>
				</table>
			</div>
		...
		<form action="../_paginas/login_usuario.php" class="right">
