...
<html lang="pt-br">
	<head>
		<title><?php $nome = $_SESSION['nome_adm']; echo "$nome - Usuários Cadastrados";?></title></title>
		<meta charset="UTF-8"/>
		...
		<div class="adm-painel">
			<div class="row">
				<?php
					...
					echo "<span style='padding: 30px; color: #16578b; font-size: 30px; font-family: Verdana; font-weight: bold; text-align: center;'>USUÁRIOS CADASTRADOS</span>";
					...
					while($usuarios_cadastrados = mysqli_fetch_array($sql_query_usuarios)){
						...
						$id_usuario = $usuarios_cadastrados['id_usuario'];
						$telefone = $usuarios_cadastrados['telefone'];
						$cidade = $usuarios_cadastrados['cidade'];
						$uf = $usuarios_cadastrados['uf'];
						echo 	"<tr>";
						echo 		"<td class='col-1' style='font-size: 10pt; padding: 10px; text-align: left;'>$id_usuario</td>";
						echo 		"<td class='col-5' style='font-size: 10pt; padding: 10px; text-align: left;'>$nome_usuario $sobrenome_usuario</td>";
						echo 		"<td class='col-3' style='font-size: 10pt; padding: 10px; text-align: left;'>$cidade-$uf</td>";
						echo 		"<td class='col-3' style='font-size: 10pt; padding: 10px; text-align: left;'>$telefone</td>";
						echo 		"<td class='col-3' style='font-size: 10pt; padding: 10px; text-align: left;'><a class='abutao' style='margin: 10px; background: red;' href='adm005-excluir.php?id_usu=$id_usuario'>Excluir</a></td>";
						echo 	"</tr>";
					}
					echo 	"<tbody>";
					echo  "</table>";
