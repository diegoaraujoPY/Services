...
<html lang="pt-br">
	<head>
		<title><?php $nome = $_SESSION['nome_adm']; echo "$nome - Categorias Cadastradas";?></title></title>
		<meta charset="UTF-8"/>
		...
		<div class="main-painel">
			<div class="row">
				<?php
					...
					echo "<span style='padding: 30px; color: #16578b; font-size: 30px; font-family: Verdana; font-weight: bold; text-align: center;'>CATEGORIAS CADASTRADAS</span>";
					...
					$sql_query_categorias = $mysqli->query($sql_categorias) or die ("Falha na execução do código SQL " . $mysqli->error);
					
					echo "<table class='table table-bordered'>";
					echo 	"<tbody>";
					
					while($categorias_cadastradas = mysqli_fetch_array($sql_query_categorias)){
						$nome_categoria = $categorias_cadastradas['nome'];
						$id_categoria = $categorias_cadastradas['id_categoria'];
						echo 	"<tr>";
						echo 		"<td class='col-8' style='font-size: 15pt; padding: 20px;'>$nome_categoria</td>";
						echo 		"<td style='padding: 20px;'><a class='abutao' href='adm004-editar.php?cat=$id_categoria&nome=$nome_categoria'>Editar</a>";
						echo 		"<a class='abutao' style='margin: 10px; background: red;' href='adm004-excluir.php?cat=$id_categoria'>Excluir</a></td>";
						echo 	"</tr>";
					}
					echo 	"<tr>";
					echo 		"<td style='padding: 20px;' colspan='2'><a class='abutao' href='adm004-inserir-categorias.php'>ADICIONAR NOVA CATEGORIA</a>";
					echo 	"</tr>";
					echo 	"<tbody>";
					echo  "</table>";
					echo "</div>";		
