		...
		<div class="main-painel">
			<div class="row">
				<?php
					...
					$nome = $_GET['nome'];
					$categoria = $_GET['cat'];
					$_SESSION['edicaocategoria'] = $categoria;
					
					echo "<div class='container'>";
					echo "<form method='POST' action='adm004-editado.php'>";
					echo "<div class='row'>";
					echo 	"<div class='col-4'>";
					echo 		"<label for='usuario' class='form-label' style='text-align: center;'>NOME DA CATEGORIA</label>";
					echo 	"</div>";
					echo 	"<div class='col'>";
					echo 		"<input type='text' class='form-control' name='categoria' value='$nome' id='usuario' required>";
					echo 	"</div>";
					echo "</div>";
