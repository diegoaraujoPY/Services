				...
				<div class="col perfil">
					<?php
						...
						while ($servico_profissional = mysqli_fetch_array($sql_query_servico)){
								...
								$permissao = $servico_profissional['aceitar'];
							...
							echo 		"<a class='abutaoeditar' style='margin: 10px;' href='contatar.php?cod_servico=$id_servico'>Sair</a>";					
									
							echo "<script language=javascript>";
								echo "function confirmar(){";
								echo 	"if (confirm('Solicitar este serviço?')){";
								echo 		"alert('Solicitação enviada com sucesso!');";
								echo 		"window.location.replace('solicitar.php?cod_servico=$id_servico');";
								echo 	"} else {";
								echo 		"window.location.replace('contratar.php?cod_servico=$id_servico');";
								echo 	"}";
								echo "}";
								echo "function cancelar(){";
								echo 	"if (confirm('Cancelar solicitação?')){";
								echo 		"alert('Solicitação cancelada!');";
								echo 		"window.location.replace('excluir_solicitacao.php?cod_servico=$id_servico');";
								echo 	"} else {";
								echo 		"window.location.replace('contratar.php?cod_servico=$id_servico');";
								echo 	"}";
								echo "}";
							echo "</script>";
									...
									if($status == 'DISPONÍVEL'){
										...
										else if($permissao==$id_usuario){
											echo "<a class='abutaoexcluir' href='' onclick='cancelar()' style='margin: 10px;'>Cancelar</a>";	
											echo "<a class='abutaodesabilitado' style='margin: 10px;'>Solicitado</a>";		
										} else if($permissao==0){
											echo "<a class='abutao' style='margin: 10px;' href='#' onclick='confirmar()'>Solicitar</a>";
										} else {
											echo "<a class='abutaodesabilitado' style='margin: 10px;'>Em espera</a>";
										}
									} else {
										echo "<a class='abutaodesabilitado' style='margin: 10px;'>Em serviço</a>";
									}
							echo "</div>";
						}
