				...
				<div class="col perfil">
					<?php
						...
						while ($servico_profissional = mysqli_fetch_array($sql_query_servico)){
							...
							echo "<span style='font-size: 30px; font-family: Verdana; color: #16578b; font-weight: bold; text-align: center;'>Formas de Contato ($nome_profissional)</span><br>";
							echo 	"<div class='row avaliados'>";
							echo 		"<span><img src='../_icones/endereco.png' width='40' height='40' style='margin: 10px;'/><b>ENDEREÇO</b></span><br>";
							echo 		"<span>Cidade: $cidade_profissional-$uf_profissional</span><br>";
							echo 		"<span>Bairro: $bairro_profissional</span><br>";
							echo 		"<span>Rua: $rua_profissional, n° $n_profissional</span><br>";
							echo 	"</div>";
							echo 	"<div class='row avaliados'>";
							echo 		"<div class='col-1'>";
							echo 			"<img src='../_dashboard/_icones/telefone.png' width='40' height='40'/>";
							echo 		"</div>";
							echo 		"<div class='col'>";
							echo 			"<span style='font-size: 25px; font-family: Verdana; color: #16578b; font-weight: bold; text-align: center;'> $telefone_profissional </span><br>";
							echo 		"</div>";
							echo 	"</div>";
							...
							if($insta_profissional == ''){
								...
								echo 	"<div class='row avaliados'>";
								echo 		"<div class='col-1'>";
								echo 			"<img src='../_dashboard/_icones/insta.png' width='40' height='40'/>";
								echo 		"</div>";
								echo 		"<div class='col'>";
								echo 			"<span style='font-size: 25px; font-family: Verdana; color: #16578b; font-weight: bold; text-align: center;'>@$insta_profissional</span><br>";
								echo 		"</div>";
								echo 	"</div>";
							}
							...
							if($face_profissional == ''){
								...
								echo 	"<div class='row avaliados'>";
								echo 		"<div class='col-1'>";
								echo 			"<img src='../_dashboard/_icones/face.png' width='40' height='40'/>";
								echo 		"</div>";
								echo 		"<div class='col'>";
								echo 			"<span style='font-size: 25px; font-family: Verdana; color: #16578b; font-weight: bold; text-align: center;'>$face_profissional</span><br>";
								echo 		"</div>";
								echo 	"</div>";
							...
							if($zap_profissional == ''){
								...
								echo 	"<div class='row avaliados'>";
								echo 		"<div class='col-1'>";
								echo 			"<img src='../_dashboard/_icones/zap.png' width='40' height='40'/>";
								echo 		"</div>";
								echo 		"<div class='col'>";
								echo 			"<span style='font-size: 25px; font-family: Verdana; color: #16578b; font-weight: bold; text-align: center;'>$zap_profissional</span><br>";
								echo 		"</div>";
								echo 	"</div>";
							}
							
							echo "<br><a class='abutao' style='margin: 10px;' href='contratar.php?cod_servico=$id_servico'>Contratar</a>";
							echo 	"<a class='abutaoeditar' style='margin: 10px;' href='contatar.php?cod_servico=$id_servico'>Voltar</a>";
